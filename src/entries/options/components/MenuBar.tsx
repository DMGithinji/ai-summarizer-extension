...
const MenuBar = () => {
  ...
  const handleReviewClick = () => {
    window.open('https://chromewebstore.google.com/detail/justtldr-free-ai-summariz/cmnjpgpkkdmkkmpliipnmhbelgbiefpa/reviews', '_blank');
  };
  ...
  const handleFeedbackSubmit = async () => {
    const feedbackData = {
      google_sheet: "justTLDR Feedback", // Name of GoogleSheet
      message: feedback,
      type: "Uninstall Reason",
      email: email || null,
    };

    setSubmitting(true);
    try {
      const response = await fetch("https://feedback-to-sheets.onrender.com/feedback/", {
        method: "POST",
        headers: {
    ...
    <>
      <div className="w-full bg-neutral-800 text-white py-3 px-4 flex items-center justify-between sticky top-0 shadow z-[100]">
        <div className="flex items-center">
          <span className="font-medium text-base">justTLDR: Free AI Summarizer</span>
        </div>
          ...
          <div className="bg-neutral-900 text-white rounded-lg shadow-xl max-w-md w-full p-6">
            ...
            <div className="space-y-2 pb-3 text-center">
              ...
              <p className="text-neutral-400 text-base">
                Your thoughts help make justTLDR better. Let us know what’s on your mind! 🌟
              </p>
            </div>
            ...
            <div className="space-y-4 py-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <label htmlFor="want-response" className="text-sm font-medium">
